            ...
            <div class="container-fluid">
                <div class="col-md-3">
                    <div class="author-image">
                        <img src="../_assets/images/16.jpg" alt="User Image">
                    </div>
                </div>
                <div class="container">
                    <h1 style="color: white">Welcome, <?= htmlspecialchars($nama_user); ?>!</h1>
                    <p style="color: white;">This is your personalized dashboard. Use the menu to navigate.</p>
                    
                    <!-- User-specific data -->
                    <div class="row">
                        <div class="col-md-12">
                            <h3 style="color: white;">Dashboard Content</h3>
                            <p style="color: white;">As a <strong>
