<?php include_once('../_header.php'); ?>
     ...
     <div class="slides">
          <div class="slide" id="3">
            <div class="content third-content" style="color: white;">
         <h1>Pasien</h1>
         <h4>
         ...
         <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                <form action="proses.php" method="post">
                   ...
                   <div class="form-group">
                        <label form="no_ktp">No. KTP</label>
                        <input type="number" name="no_ktp" id="no_ktp" class="form-control" required autofocus>
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                        <label form="no_rm">No. Rekam Medis</label>
                        <input type="number" name="no_rm" id="no_rm" class="form-control" required autofocus>
                   </div>
                   <div class="form-group">
